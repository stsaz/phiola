...
#define errlog(t, ...)  phi_errlog(core, "directsound", t, __VA_ARGS__)
#define warnlog(t, ...)  phi_warnlog(core, "directsound", t, __VA_ARGS__)
#define dbglog(t, ...)  phi_dbglog(core, "directsound", t, __VA_ARGS__)
